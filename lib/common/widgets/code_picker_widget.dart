          ...
          child: Container(
            ...
            child: Dialog(
              child: SelectionDialog(
                ...
                flagDecoration: widget.flagDecoration, hideHeaderText: true, headerAlignment: MainAxisAlignment.center, headerTextStyle: TextStyle(), topBarPadding: EdgeInsets.zero,
              ),
            ),
          ),
        ),
      ...
      showModalBottomSheet(
        ...
        builder: (context) => Center(
          child: SelectionDialog(
            ...
            barrierColor: widget.barrierColor,
            hideSearch: widget.hideSearch!,
            closeIcon: widget.closeIcon, hideHeaderText: true, headerAlignment: MainAxisAlignment.center, headerTextStyle: TextStyle(), topBarPadding: EdgeInsets.zero
          ),
        ),
      ).then((e) {
        if (e != null) {
