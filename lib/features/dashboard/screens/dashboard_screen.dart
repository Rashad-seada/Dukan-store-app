...
import 'package:dukan_store_app/features/dashboard/widgets/bottom_nav_item_widget.dart';
import 'package:dukan_store_app/features/home/screens/home_screen.dart';
import 'package:dukan_store_app/features/menu/screens/menu_screen.dart';
import 'package:dukan_store_app/features/order/screens/order_history_screen.dart';
        ...
        NavigationBar(
            ...
            destinations: [
              NavigationDestination(
                icon: Icon(Icons.home,color:_pageIndex == 0 ? Colors.red : Colors.black,),
                label: "",
              ),
              NavigationDestination(
                icon: Icon(Icons.shopping_bag_rounded,color:_pageIndex == 1 ? Colors.red : Colors.black,),
                label: "",
              ),
              Container(
                width: 50,
              ...
              NavigationDestination(
                icon: Icon(Icons.monetization_on,color:_pageIndex == 3 ? Colors.red : Colors.black,),
                label: "",
              ),
              NavigationDestination(
                icon: Icon(Icons.menu,color:_pageIndex == 4 ? Colors.red : Colors.black,),
                label: "",
              )
            ]),
        // BottomAppBar(
